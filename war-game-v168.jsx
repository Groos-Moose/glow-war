...
function WarPathRow({spoils,warCard,glow,isPlayer,fam,inWar,pathBg,pathBorder,revealed,warCollect,rw,pol,carpetDelta,warCardRef,onAnimDone,mercySpoils,mercySide,dw2Sp,dw2W,dw2Revealed,dw2Round,dimWar1,onWinCardClick}){
          ...
          return sl.card
            ?<div key={`wrap-${sl.k}`} ref={!sl.isSpoil?warCardRef:null} style={{
              ...
              onTransitionEnd={e=>{
                ...
                <div style={{filter:dimWar1?"brightness(0.5)":undefined,
...
function Battlefield({bf,cpuFam,plFam,quip,pol,pCollectRef:pCRef,cCollectRef:cCRef,dealIntro,introDelt,introTotal,onDealClick,onAnimDone,animStepRef,CW=60,CH=87,csSmall=false,csMed=false,csLg=true,pTotal=0,cTotal=0,potCards=0,onTapPile}){
  ...
  const dimDuel=["war","war_card","war_reveal","double_war","double_war_card","double_reveal"].includes(phase);
  const dimWar1=["double_war","double_war_card","double_reveal"].includes(phase);
        ...
        <div style={{width:"22%",flexShrink:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:2}}>
          ...
          <div ref={plFightRef} style={{position:"relative",width:CW,height:CH}}>
            ...
            {plF&&<div style={{position:"absolute",inset:0,
              ...
              cursor:(fpg==="win"&&onTapPile)?"pointer":undefined,
              filter:dimDuel?"brightness(0.5)":undefined}}
              ...
              onClick={(fpg==="win"&&onTapPile)?onTapPile:undefined}>
  ...
  return(
    <div style={{position:"absolute",inset:0,zIndex:200,background:"rgba(0,0,0,.92)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{background:"linear-gradient(160deg,#1a0f05,#0f0a1a)",border:"2px solid rgba(218,165,32,.5)",borderRadius:18,padding:"22px 20px",width:"88%",maxWidth:340,maxHeight:"90vh",overflowY:"auto",position:"relative"}}>
        ...
        <div style={{fontSize:9,color:"rgba(218,165,32,.65)",textAlign:"center",letterSpacing:1.5,marginBottom:14}}>v168</div>
...
export default function App(){
  ...
  const [config,setConfig]=useState(()=>{
    ...
    const defaults={muted:true,volume:.7,pileSide:"right",showMsg:true,autoSpeed:0,gameMode:"cards",warTarget:3,warAutoFill:false,logEvents:true,cardSize,showDevBar:true};
