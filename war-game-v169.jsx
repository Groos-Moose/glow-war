  ...
  return(
    <div style={{position:"absolute",inset:0,zIndex:200,background:"rgba(0,0,0,.92)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{background:"linear-gradient(160deg,#1a0f05,#0f0a1a)",border:"2px solid rgba(218,165,32,.5)",borderRadius:18,padding:"22px 20px",width:"88%",maxWidth:340,maxHeight:"90vh",overflowY:"auto",position:"relative"}}>
        ...
        <div style={{fontSize:9,color:"rgba(218,165,32,.65)",textAlign:"center",letterSpacing:1.5,marginBottom:14}}>v169</div>
...
export default function App(){
  ...
  const startGame=useCallback(()=>{
    clearTimeout(autoRef.current); resetWarSlots(); setConfirmRestart(false); setSurrenderModal(false); gWinRef.current=null; pendingWarWinRef.current=null; setLastRig(0); pWarWinsRef.current=0; cWarWinsRef.current=0; setLongestSiege(0); setMercyHits(0); setRoyalsCaptured(0); playerTapsRef.current=0; warCardsWonRef.current=0; setPtsCaptured(0); setPtsLost(0); setMaxPtsCap(0); setMaxPtsLost(0); evtsCapRef.current=0; evtsLostRef.current=0;
